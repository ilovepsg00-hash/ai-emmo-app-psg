...
const MDEditor = dynamic(() => import('@uiw/react-md-editor'), {
  ...
  loading: () => (
    <div
      className="flex min-h-[420px] items-center justify-center rounded-lg border border-gray-200 bg-gray-50 text-sm text-gray-500"
      role="status"
      aria-live="polite"
    >
      마크다운 편집기를 불러오는 중...
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                <MDEditor
                  ...
                  commandsFilter={(cmd: ICommand) =>
                    ALLOWED_COMMANDS.includes(cmd.name ?? '')
                      ? cmd
                      : false
                  }
                  textareaProps={{
                    placeholder:
                      '메모 내용을 마크다운으로 작성하세요\n\n## 제목\n**굵게**, *기울임*, `인라인 코드`\n- 목록 항목',
                    'aria-labelledby': 'memo-content-label',
                  }}
                  previewOptions={{
              ...
              <p className="mt-1.5 text-xs text-gray-400">
                왼쪽에서 마크다운을 입력하면 오른쪽에서 실시간으로 미리볼 수 있습니다.
              </p>
            </div>
