...
- `@uiw/react-md-editor` — 마크다운 편집·프리뷰(`MemoForm`), 읽기 전용 렌더(`MemoDetailModal`)
...
| `MemoDetailModal.tsx` | 메모 상세 보기 모달(읽기 전용 + 편집/삭제 + Gemini AI 요약) |
| `MarkdownViewer.tsx` | 마크다운 읽기 전용 뷰어 (SSR 비활성 클라이언트 컴포넌트) |
